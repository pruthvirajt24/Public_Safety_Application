                      ...
                      children: [
                          ...
                          child: Column(
                            children: [
                              ...
                              CustomTextField(
                                ...
                                validate: (gmail) {
                                  if (gmail!.isEmpty ||
                                      gmail.length < 3 && gmail.contains('@')) {
                                    return 'Enter correct guardian email';
                                  }
                                  return null;
                                },
                                onsave: (gmail) {
                                  registerViewModel.formdata['gmail'] =
                                      gmail ?? "";
                                },
                              ),
                              SizedBox(height: size.height * 0.02),
                              CustomTextField(
                                ...
                                isPassword: registerViewModel.isPassword.value,
                              ...
                              CustomTextField(
                                ...
                                isPassword: registerViewModel.isCPassword.value,
                                prefix: const Icon(Icons.lock),
                                validate: (confirm) {
                                  if (confirm!.isEmpty || confirm.length < 7) {
                                    return 'Enter correct password';
                                  }
                                  return null;
                                },
                        ...
                        PrimaryButton(
                            ...
                            onPressed: () {
                              ...
                              registerViewModel.signUp('child');
                            }),
                        SizedBox(height: size.height * 0.02),
                        Row(
