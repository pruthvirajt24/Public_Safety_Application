...
import 'package:women_safety_app/view_model/auth/police_register_view_model.dart';
import 'package:women_safety_app/views/child/auth/login_screen.dart';

class RegisterPoliceScreen extends StatelessWidget {
  const RegisterPoliceScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    var size = MediaQuery.of(context).size;
    final registerViewModel = Get.put(PoliceRegisterModel());
                            ...
                            child: Column(
                              children: [
                                ...
                                CustomTextField(
                                  ...
                                  textInputAction: TextInputAction.next,
                                  keyboardtype: TextInputType.text,
                                  prefix: const Icon(Icons.shield),
                                  validate: (badgeNumber) {
                                    if (badgeNumber!.isEmpty ||
                                        badgeNumber.length < 3) {
                                      return 'Enter correct badge number';
                                    }
                                    return null;
                                  },
                                  onsave: (badgeNumber) {
                                    registerViewModel.formdata['badgeNumber'] =
                                        badgeNumber ?? "";
                                  },
                                ),
                                SizedBox(height: size.height * 0.02),
